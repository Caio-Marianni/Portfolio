...
<template>
  <div class="flex items-center w-full mt-6 rounded-[20px] overflow-hidden shadow-2xl z-20">
    <!-- Navigation -->
    <div class="relative w-full bg-[#141414] h-[110px] py-5 pl-5 rounded-l-[20px]">
    ...
    <!-- Final background Detail -->
    <img class="h-[110px] w-[300px] bg-[#141414] md:bg-transparent" src="../assets/final.webp" alt="">
